...
var program = require( 'commander' ),
    path = require( 'path' ),
    optcliPackage = require( path.join( __dirname, '../', 'package.json' )),
...
var loadCommand = function( cmd ) {
    ...
    return function() {
        ...
        require( '../lib/commands/' + cmd ).apply( _this, arguments );
    }
}
...
program
    .command( 'pull-variation <path>' )
    .description( 'Pull (read) a variation from Optimizely' )
    .action( loadCommand( 'pull-variation' ));
