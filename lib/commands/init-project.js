...
var pullRemoteProject = function( id, program ) {
    ...
    readConfig( 'token' )
        ...
        .then( function( token ) {
            ...
            return optClient.getProject( id ).then( function( project ) {
...
var createLocalProject = function( id, program ) {
    ...
    var defaultAttrs = {
        ...
        theProject = new Project( defaultAttrs, './' );
...
module.exports = function( id, program ) {
    ...
    if ( program.remote ) pullRemoteProject( id, program );
    else createLocalProject( id, program );
